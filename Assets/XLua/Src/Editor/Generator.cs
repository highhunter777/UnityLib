...
#else
        public static string common_path = Application.dataPath + "/XLua/Src/Gen/"; // Gen 须位于 xLua.asmdef 覆盖范围内：generated 的 internal partial class InternalGlobals 需与 Src 同程序集合并
#endif
